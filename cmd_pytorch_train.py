...
datafile_all = os.path.join(corpus, "../formatted_pairs.txt")
...
with open(datafile_all, 'w', encoding='utf-8') as outputfile:
...
datafile = os.path.join(corpus, "../cmd_train_pairs.txt")
class Voc:
